...
<?php
    ...
    ?>
        <tr>
            ...
            <td><a href="../controller/clientController.php?cpf=<?php echo $dadoscliente->cpf?>&acao=excluir" >Excluir</a> | <a href="cadastrar.php?cpf=<?php echo $dadoscliente->cpf?>&acao=editar" >Editar</a> </td>
        </tr>
    <?php
        }
        $dados ->free_result();
